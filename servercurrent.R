...
server <- function(input, output) {
  ...
  output$resultstableLeft1.7 <- renderTable({
    ...
    PeakForcePC <- rbind(round(PeakHop1PC,digits=2), round(PeakHop2PC,digits=2), round(PeakHop3PC,digits=2), round(PeakHop4PC,digits=2), round(PeakHop5PC,digits=2), round(PeakHop6PC,digits=2), round(PeakHop7PC,digits=2), round(PeakHop8PC,digits=2), round(PeakHop9PC,digits=2), round(PeakHop10PC,digits=2), round(PeakHop11PC,digits=2), round(PeakHop12PC,digits=2), round(PeakHop13PC,digits=2), round(PeakHop14PC,digits=2), round(PeakHop15PC,digits=2))
