...
TxtData = dlg_open(Title = "Select a hop file")$res

data1 <- 
  read.csv(TxtData, stringsAsFactors = F, skip = 17)
...
# EccStiffHop2 = ((PeakHop2 - BW)/EccHop2Disp)/Mass
# 
...
# EccStiffHop3 = ((PeakHop3 - BW)/EccHop3Disp)/Mass
# 
...
# EccStiffHop4 = ((PeakHop4 - BW)/EccHop4Disp)/Mass
# 
...
# EccStiffHop5 = ((PeakHop5 - BW)/EccHop5Disp)/Mass
# 
...
# EccStiffHop6 = ((PeakHop6 - BW)/EccHop6Disp)/Mass
# 
...
# EccStiffHop7 = ((PeakHop7 - BW)/EccHop7Disp)/Mass
# 
...
# EccStiffHop8 = ((PeakHop8 - BW)/EccHop8Disp)/Mass
# 
...
# EccStiffHop9 = ((PeakHop9 - BW)/EccHop9Disp)/Mass
# 
...
# EccStiffHop10 = ((PeakHop10 - BW)/EccHop10Disp)/Mass
# 
...
# EccStiffHop11 = ((PeakHop11 - BW)/EccHop11Disp)/Mass
# 
...
# EccStiffHop12 = ((PeakHop12 - BW)/EccHop12Disp)/Mass
# 
...
# EccStiffHop13 = ((PeakHop13 - BW)/EccHop13Disp)/Mass
# 
...
# EccStiffHop14 = ((PeakHop14 - BW)/EccHop14Disp)/Mass
# 
...
# EccStiffHop15 = ((PeakHop15 - BW)/EccHop15Disp)/Mass
# 
