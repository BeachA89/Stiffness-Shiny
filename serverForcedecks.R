...
server <- function(input, output) {
  ...
  output$resultstableLeft1.7 <- renderTable({
    ...
    for (r in 1:13){
      ...
      assign(paste0("ContactTimeHop", r, sep = ""), (length(HopDisp) - ContactHop)*0.002)
      ...
      assign(paste0("JumpFreqHop", r, sep = ""), 1/(length(FullHops[[r]])*0.002))
    ...
    EccCOMDisp <- rbind(round(EccHopDisp1,digits=2), round(EccHopDisp2,digits=2), round(EccHopDisp3,digits=2), round(EccHopDisp4,digits=2), round(EccHopDisp5,digits=2), round(EccHopDisp6,digits=2), round(EccHopDisp7,digits=2), round(EccHopDisp8,digits=2), round(EccHopDisp9,digits=2), round(EccHopDisp10,digits=2), round(EccHopDisp11,digits=2), round(EccHopDisp12,digits=2), round(EccHopDisp13,digits=2))
    ContactTime <- rbind(round(ContactTimeHop1,digits=2), round(ContactTimeHop2,digits=2), round(ContactTimeHop3,digits=2), round(ContactTimeHop4,digits=2), round(ContactTimeHop5,digits=2), round(ContactTimeHop6,digits=2), round(ContactTimeHop7,digits=2), round(ContactTimeHop8,digits=2), round(ContactTimeHop9,digits=2), round(ContactTimeHop10,digits=2), round(ContactTimeHop11,digits=2), round(ContactTimeHop12,digits=2), round(ContactTimeHop13,digits=2))
    EccStiffness <- rbind(round(EccStiffHop1,digits=2), round(EccStiffHop2,digits=2), round(EccStiffHop3,digits=2), round(EccStiffHop4,digits=2), round(EccStiffHop5,digits=2), round(EccStiffHop6,digits=2), round(EccStiffHop7,digits=2), round(EccStiffHop8,digits=2), round(EccStiffHop9,digits=2), round(EccStiffHop10,digits=2), round(EccStiffHop11,digits=2), round(EccStiffHop12,digits=2), round(EccStiffHop13,digits=2))
    PeakForcePC <- rbind(round(PeakHopPC1,digits=2), round(PeakHopPC2,digits=2), round(PeakHopPC3,digits=2), round(PeakHopPC4,digits=2), round(PeakHopPC5,digits=2), round(PeakHopPC6,digits=2), round(PeakHopPC7,digits=2), round(PeakHopPC8,digits=2), round(PeakHopPC9,digits=2), round(PeakHopPC10,digits=2), round(PeakHopPC11,digits=2), round(PeakHopPC12,digits=2), round(PeakHopPC13,digits=2))
    JumpFreq <- rbind(round(JumpFreqHop1,digits=2), round(JumpFreqHop2,digits=2), round(JumpFreqHop3,digits=2), round(JumpFreqHop4,digits=2), round(JumpFreqHop5,digits=2), round(JumpFreqHop6,digits=2), round(JumpFreqHop7,digits=2), round(JumpFreqHop8,digits=2), round(JumpFreqHop9,digits=2), round(JumpFreqHop10,digits=2), round(JumpFreqHop11,digits=2), round(JumpFreqHop12,digits=2), round(JumpFreqHop13,digits=2))
    
    avgEccCOMDisp = round(mean(EccCOMDisp[4:13]),digits=2)
    avgContactTime = round(mean(ContactTime[4:13]),digits=2)
    avgEccStiffness = round(mean(EccStiffness[4:13]),digits=2)
    avgPeakForcePC = round(mean(PeakForcePC[4:13]),digits=2)
    avgJumpFreq = round(mean(JumpFreq[4:13]),digits=2)
    
    values$Left1.7Averages <-  cbind(avgEccCOMDisp, avgContactTime, avgEccStiffness, avgPeakForcePC,avgJumpFreq)
